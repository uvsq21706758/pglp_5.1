...
public class AppTest {
	    ...
	    public void setUp() throws IOException {
	        Numero_telephone portable =new Numero_telephone(Type_tel.portable, "06123456775");
	    ...
	    public void deleteTest() throws IOException, ClassNotFoundException {      
	        Numero_telephone portable =new Numero_telephone(Type_tel.portable, "0634256788");
